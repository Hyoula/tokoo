<div style="margin-top:20px;"class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-dark shadow-sm">
			<?php echo form_open('toko/search') ?>
			<button class="btn btn-primary btn-sm m-1" type="submit">Show All</button>
  ...
  <div class="carousel-inner">
      ...
      <img src="<?php echo base_url()?>assets/img/casual/H22183-FW19_BOOST_BLOCKBUSTER_Social_Winterized_Mens_White_TWcarousel_Frame3-532710.jpg" class="d-block w-100">
      </div>
      <div class="carousel-item" data-interval="2000">
      <img src="<?php echo base_url()?>assets/img/casual/Golden-Goose-Superstar-Sneakers-Review.jpg" class="d-block w-100">
      </div>
      <div class="carousel-item">
      <img src="<?php echo base_url()?>assets/img/casual/125811_style-khas-millennials-di-tahun-2016-2017-kemarin-adalah-alas-kaki-bergaya-sporty-kasual-bernuansa-putih-dengan-tampilan-busana-edgy-ini-tips-perawatan-sepatu-kets-berwarna-putih.jpg" class="d-block w-100" >
      </div>
  </div>
