<div style="margin-top:20px;"class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">The Coolest</h1>
    <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>
  </div>
  <div id="carouselExampleInterval" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
      <div class="carousel-item active" data-interval="10000">
      <img src="<?php echo base_url()?>assets/img/casual/hero-1080x400.jpg" class="d-block w-100">
      </div>
      <div class="carousel-item" data-interval="2000">
      <img src="<?php echo base_url()?>assets/img/casual/ArcticGripW2019-1-1080x400.jpg" class="d-block w-100">
      </div>
      <div class="carousel-item">
      <img src="<?php echo base_url()?>assets/img/casual/jonathan-borba-duvnLKB-VnI-unsplash-1-1080x420.jpg" class="d-block w-100" >
      </div>
  </div>
