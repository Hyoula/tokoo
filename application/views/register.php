        ...
        <div class="row">
          <div class="col-lg">
            <div class="p-5">
              ...
              <form class="user" method="post" action="<?php echo base_url('daftar/index')?>">
                ...
                <button type="submit" class="btn btn-primary btn-user btn-block">Regitrasi</button>
                <hr>
              </form>
              <hr>
              <div class="text-center">
                <a class="small" href="<?php echo base_url('out/login')?>">Sign In</a>
              </div>
            </div>
          </div>
        </div>
